    ...
    class Registration < Utils::Command
      ...
      def post_params
        params = super.merge({
          ...
          "CardHolder"         => card_details.card_holder,
        ...
        params['StartDate']        = card_details.start_date       if card_details.start_date.present?
        params['IssueNumber']      = card_details.issue_number     if card_details.start_date.present?
        params['CV2']              = card_details.cv2              if card_details.cv2.present?
        ...
        params['PayPalCallbackURL']= pay_pal_callback_url          if pay_pal_callback_url.present?
